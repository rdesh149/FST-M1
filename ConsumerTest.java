...
public class ConsumerTest {
    ...
    public RequestResponsePact createPact(PactDslWithProvider builder) {
        ...
        DslPart requestBody = new PactDslJsonBody()
                .numberType("id", 7001)
                .stringType("firstName", "Rohan")
                .stringType("lastName", "Deshmukh")
                .stringType("email", "rohan@example.com");
    ...
    public void postRequestTest(){
        ...
        reqBody.put("id", 7001);
        reqBody.put("firstName", "Rohan"); // Correct the key to match Pact
        reqBody.put("lastName", "Deshmukh"); // Correct the key to match Pact
        reqBody.put("email", "rohan@example.com");
